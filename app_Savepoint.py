...
# Ultra-modern CSS inspired by Linear, Notion, and modern SaaS apps
st.markdown("""
<style>
...
# Enhanced software markets with IBM
SOFTWARE_MARKETS = {
...
def generate_validated_quotes(company_info):
    """Generate quotes with proper date validation"""
...
def search_market_for_topic(market_name, search_term, companies):
    """Enhanced market search with better validation"""
    try:
    ...
    for i, company in enumerate(st.session_state.analysis_data['companies']):
        ...
        with tab3:
            ...
            <div class="modern-card">
                ...
                <p style="opacity: 0.8; margin-bottom: 2rem;">Recent insights from company leadership</p>
            </div>
            """, unsafe_allow_html=True)
            ...
            for quote in quotes:
                ...
                <div class="modern-card">
                    ...
                    <p style="text-align: right; margin: 0.75rem 0 0 0; color: #8b5cf6; font-weight: 600;">
                        — {quote['executive']}
                    </p>
                </div>
                """, unsafe_allow_html=True)
